...
<h2 style={{fontSize:"20px", color:"#FFDA1A" ,minWidth:"45%"}}>Cashtag Mentioned ({Object.keys(cashtagData).length})</h2>
...
//   width: "80%",
  ...
  {Object.keys(cashtagData).map((cashtag) => (
   ...
   <StatCard value={selectedData.mentions} label="Mentions" bgColor="#002c5c" />
   <StatCard value={selectedData.influencers} label="Tweets" bgColor="#002c5c" />
   <StatCard value={selectedData.community} label="Community" bgColor="#002c5c" />
   <StatCard value={selectedData.volume} label="Vol" bgColor="#A09000" />
   <StatCard value={selectedData.lp} label="LP" bgColor="#FF0000" />
   </Box>
</Box>
</>
}
